    ...
    <div>
      ...
      <Box>
        <Grid item xs sx={{ display: { xs: "block", sm: "none" } }}>
          ...
          <Divider
            sx={{ backgroundColor: "#FFFFFF", marginTop: 4 }}
            showlabels="true"
          />
          <Grid sx={{ justifyContent: "center", flexGrow: 1, display: "flex" }}>
            ...
            >
              <Typography sx={{ fontSize: "10px", marginTop: 4 }}>
                <img
              ...
              <Typography sx={{ fontSize: "12px", marginTop: 4 }}>
                <img
              ...
              <Box>
                ...
                <list>
                  <Typography sx={{ marginTop: 2 }}>
                    <img src="/image/google.jpg" width="100px" height="40px" />
                  </Typography>
                </list>
                <br />
                <list>
                  <img src="/image/app.jpg" width="100px" height="40px" />
                </list>
              </Box>
            </Grid>
          </Box>
